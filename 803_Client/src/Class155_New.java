...
public class Class155_New {
   ...
   final void method3343(boolean var1, boolean var2, int[] var3, int var4, int var5, int var6, float var7, float var8, float var9, float var10, float var11, float var12, float var13, float var14, float var15, float var16, float var17, float var18, float var19, float var20, float var21, float var22, float var23, float var24, float var25, float var26, float var27, float var28) {
      ...
      if(var5 < var6) {
         ...
         for(var4 += var5; var29-- > 0; var27 += var41) {
            ...
            if(!var1 || var42 < this.aFloatArray1739[var4]) {
               float var44 = var11 * var43;
               float var45 = var13 * var43;
               int var46 = (int)(var44 * (float)this.anInt1752 * this.aFloat1745) & this.anInt1744;
               int var47 = (int)(var45 * (float)this.anInt1752 * this.aFloat1745) & this.anInt1744;
               int var48 = this.anIntArray1725[var47 * this.anInt1752 + var46];
               var46 = (int)(var44 * (float)this.anInt1757 * this.aFloat1753) & this.anInt1742;
               var47 = (int)(var45 * (float)this.anInt1757 * this.aFloat1753) & this.anInt1742;
               int var49 = this.anIntArray1750[var47 * this.anInt1757 + var46];
               var46 = (int)(var44 * (float)this.anInt1738 * this.aFloat1758) & this.anInt1735;
               var47 = (int)(var45 * (float)this.anInt1738 * this.aFloat1758) & this.anInt1735;
               int var50 = this.anIntArray1755[var47 * this.anInt1738 + var46];
               ...
               if(var15 != 0.0F) {
                  ...
                  int var55 = ((this.anInt1740 & 16711935) * (int)var15 & -16711936 | (this.anInt1740 & '\uff00') * (int)var15 & 16711680) >>> 8;
               ...
               if(var1) {
                  this.aFloatArray1739[var4] = var42;
               }
            }
   ...
   int method3344() {
      return this.anIntArray1730[0] % this.anInt1737;
   }

   Class155_New(Class103_Sub2 var1, Class189 var2) {
      this.aClass103_Sub2_1743 = var1;
      this.aClass189_1736 = var2;
      this.anInt1737 = this.aClass103_Sub2_1743.anInt9260 * -1826993761;
      this.anIntArray1751 = this.aClass103_Sub2_1743.anIntArray9245;
      this.aFloatArray1739 = this.aClass103_Sub2_1743.aFloatArray9248;
      this.aClass529_1746 = Class529.aClass529_6942;
   }
   ...
   final void method3346(boolean var1, boolean var2, boolean var3, float var4, float var5, float var6, float var7, float var8, float var9, float var10, float var11, float var12, int var13) {
      if(this.aBool1724) {
         this.aClass103_Sub2_1743.method2517((int)var7, (int)var4, (int)var8, (int)var5, var13, 223909001);
         this.aClass103_Sub2_1743.method2517((int)var8, (int)var5, (int)var9, (int)var6, var13, 223909001);
         this.aClass103_Sub2_1743.method2517((int)var9, (int)var6, (int)var7, (int)var4, var13, 223909001);
      } else {
         ...
         if(var23 != 0.0F) {
            ...
            if(var4 <= var5 && var4 <= var6) {
               if(var4 < (float)this.anInt1726) {
                  if(var5 > (float)this.anInt1726) {
                     var5 = (float)this.anInt1726;
                  }

                  if(var6 > (float)this.anInt1726) {
                     var6 = (float)this.anInt1726;
                  }
                  ...
                  if(var5 < var6) {
                     ...
                     if((var4 == var5 || var22 >= var20) && (var4 != var5 || var22 <= var21)) {
                        ...
                        for(var4 = (float)this.anIntArray1730[(int)var4]; --var5 >= 0.0F; var4 += (float)this.anInt1737) {
                           this.method3374(var1, var2, var3, this.anIntArray1751, (int)var4, var13, 0, (int)var7, (int)var9, var10, var24);
                           var9 += var22;
                           var7 += var20;
                           var10 += var25;
                        }
                        ...
                        while(--var6 >= 0.0F) {
                           this.method3374(var1, var2, var3, this.anIntArray1751, (int)var4, var13, 0, (int)var8, (int)var9, var10, var24);
                           var9 += var22;
                           var8 += var21;
                           var10 += var25;
                           var4 += (float)this.anInt1737;
                        }
                        ...
                        for(var4 = (float)this.anIntArray1730[(int)var4]; --var5 >= 0.0F; var4 += (float)this.anInt1737) {
                           this.method3374(var1, var2, var3, this.anIntArray1751, (int)var4, var13, 0, (int)var9, (int)var7, var10, var24);
                           var9 += var22;
                           var7 += var20;
                           var10 += var25;
                        }
                        ...
                        while(--var6 >= 0.0F) {
                           this.method3374(var1, var2, var3, this.anIntArray1751, (int)var4, var13, 0, (int)var9, (int)var8, var10, var24);
                           var9 += var22;
                           var8 += var21;
                           var10 += var25;
                           var4 += (float)this.anInt1737;
                     ...
                     if((var4 == var6 || var22 >= var20) && (var4 != var6 || var21 <= var20)) {
                        ...
                        for(var4 = (float)this.anIntArray1730[(int)var4]; --var6 >= 0.0F; var4 += (float)this.anInt1737) {
                           this.method3374(var1, var2, var3, this.anIntArray1751, (int)var4, var13, 0, (int)var7, (int)var8, var10, var24);
                           var8 += var22;
                           var7 += var20;
                           var10 += var25;
                        }
                        ...
                        for(var4 = (float)this.anIntArray1730[(int)var4]; --var6 >= 0.0F; var4 += (float)this.anInt1737) {
                           this.method3374(var1, var2, var3, this.anIntArray1751, (int)var4, var13, 0, (int)var8, (int)var7, var10, var24);
                           var8 += var22;
                           var7 += var20;
                           var10 += var25;
                        }
               ...
               if(var5 < (float)this.anInt1726) {
                  ...
                  if(var6 < var4) {
                     ...
                     if((var5 == var6 || var20 >= var21) && (var5 != var6 || var20 <= var22)) {
                        ...
                        for(var5 = (float)this.anIntArray1730[(int)var5]; --var6 >= 0.0F; var5 += (float)this.anInt1737) {
                           this.method3374(var1, var2, var3, this.anIntArray1751, (int)var5, var13, 0, (int)var8, (int)var7, var11, var24);
                           var7 += var20;
                           var8 += var21;
                           var11 += var25;
                        }
                        ...
                        while(--var4 >= 0.0F) {
                           this.method3374(var1, var2, var3, this.anIntArray1751, (int)var5, var13, 0, (int)var9, (int)var7, var11, var24);
                           var7 += var20;
                           var9 += var22;
                           var11 += var25;
                           var5 += (float)this.anInt1737;
                        }
                        ...
                        for(var5 = (float)this.anIntArray1730[(int)var5]; --var6 >= 0.0F; var5 += (float)this.anInt1737) {
                           this.method3374(var1, var2, var3, this.anIntArray1751, (int)var5, var13, 0, (int)var7, (int)var8, var11, var24);
                           var7 += var20;
                           var8 += var21;
                           var11 += var25;
                        }
                        ...
                        while(--var4 >= 0.0F) {
                           this.method3374(var1, var2, var3, this.anIntArray1751, (int)var5, var13, 0, (int)var7, (int)var9, var11, var24);
                           var7 += var20;
                           var9 += var22;
                           var11 += var25;
                           var5 += (float)this.anInt1737;
                     ...
                     if(var20 < var21) {
                        ...
                        for(var5 = (float)this.anIntArray1730[(int)var5]; --var4 >= 0.0F; var5 += (float)this.anInt1737) {
                           this.method3374(var1, var2, var3, this.anIntArray1751, (int)var5, var13, 0, (int)var9, (int)var8, var11, var24);
                           var9 += var20;
                           var8 += var21;
                           var11 += var25;
                        }
                        ...
                        for(var5 = (float)this.anIntArray1730[(int)var5]; --var4 >= 0.0F; var5 += (float)this.anInt1737) {
                           this.method3374(var1, var2, var3, this.anIntArray1751, (int)var5, var13, 0, (int)var8, (int)var9, var11, var24);
                           var9 += var20;
                           var8 += var21;
                           var11 += var25;
                        }
            ...
            } else if(var6 < (float)this.anInt1726) {
               if(var4 > (float)this.anInt1726) {
                  var4 = (float)this.anInt1726;
               }
               ...
               if(var4 < var5) {
                  ...
                  if(var21 < var22) {
                     ...
                     for(var6 = (float)this.anIntArray1730[(int)var6]; --var4 >= 0.0F; var6 += (float)this.anInt1737) {
                        this.method3374(var1, var2, var3, this.anIntArray1751, (int)var6, var13, 0, (int)var8, (int)var9, var12, var24);
                        var8 += var21;
                        var9 += var22;
                        var12 += var25;
                     }
                     ...
                     while(--var5 >= 0.0F) {
                        this.method3374(var1, var2, var3, this.anIntArray1751, (int)var6, var13, 0, (int)var8, (int)var7, var12, var24);
                        var8 += var21;
                        var7 += var20;
                        var12 += var25;
                        var6 += (float)this.anInt1737;
                     }
                     ...
                     for(var6 = (float)this.anIntArray1730[(int)var6]; --var4 >= 0.0F; var6 += (float)this.anInt1737) {
                        this.method3374(var1, var2, var3, this.anIntArray1751, (int)var6, var13, 0, (int)var9, (int)var8, var12, var24);
                        var8 += var21;
                        var9 += var22;
                        var12 += var25;
                     }
                     ...
                     while(--var5 >= 0.0F) {
                        this.method3374(var1, var2, var3, this.anIntArray1751, (int)var6, var13, 0, (int)var7, (int)var8, var12, var24);
                        var8 += var21;
                        var7 += var20;
                        var12 += var25;
                        var6 += (float)this.anInt1737;
                  ...
                  if(var21 < var22) {
                     ...
                     for(var6 = (float)this.anIntArray1730[(int)var6]; --var5 >= 0.0F; var6 += (float)this.anInt1737) {
                        this.method3374(var1, var2, var3, this.anIntArray1751, (int)var6, var13, 0, (int)var7, (int)var9, var12, var24);
                        var7 += var21;
                        var9 += var22;
                        var12 += var25;
                     }
                     ...
                     for(var6 = (float)this.anIntArray1730[(int)var6]; --var5 >= 0.0F; var6 += (float)this.anInt1737) {
                        this.method3374(var1, var2, var3, this.anIntArray1751, (int)var6, var13, 0, (int)var9, (int)var7, var12, var24);
                        var7 += var21;
                        var9 += var22;
                        var12 += var25;
                     }
   ...
   final void method3347(boolean var1, boolean var2, int[] var3, int var4, int var5, int var6, int var7, int var8, float var9, float var10, float var11, float var12) {
      ...
      if(var7 < var8) {
         ...
         int var14;
         int var15;
         if(this.aClass189_1736.aBool2220) {
            if(this.aBool1721) {
               var6 = var8 - var7 >> 2;
               var10 *= 4.0F;
               if(this.anInt1723 == 0) {
                  if(var6 > 0) {
                     do {
                        ...
                        var9 += var10;
                        ++var4;
                        if(!var1 || var11 < this.aFloatArray1739[var4]) {
                           var3[var4] = var5;
                           if(var1) {
                              this.aFloatArray1739[var4] = var11;
                           }
                        }
                  ...
                  var13 = this.anInt1723;
                  var14 = 256 - this.anInt1723;
                  if(var6 > 0) {
                     do {
                        var5 = Class474.anIntArray6382[(int)var9 & '\uffff'];
                        var9 += var10;
   ...
   final void method3348(boolean var1, boolean var2, boolean var3, float var4, float var5, float var6, float var7, float var8, float var9, float var10, float var11, float var12, float var13, float var14, float var15, float var16, float var17, float var18, float var19, float var20, float var21, int var22, int var23, int var24, int var25, float var26, float var27, float var28, int var29, int var30) {
      if(!var1) {
         this.method3377(false, var2, var3, var4, var5, var6, var7, var8, var9, var10, var11, var12, 0);
      } else {
         int var31 = (var29 & '\uffff') << 16 | var30 & '\uffff';
         int var33;
         if(var31 != this.anInt1734) {
            this.anIntArray1725 = this.aClass103_Sub2_1743.method15389(var29, var30);
            if(this.anIntArray1725 == null) {
               this.anInt1734 = -1;
               this.anInt1723 = 255 - (var22 >> 24 & 255);
               this.anInt1747 = 0;
               int var76 = Class474.anIntArray6382[Class241_Sub42.method16451(this.aClass103_Sub2_1743.method15368(var29), 280235293) & '\uffff'];
               var33 = -16777216 | (var22 >> 16 & 255) * (var76 >> 16 & 255) << 8 & 16711680 | (var22 >> 8 & 255) * (var76 >> 8 & 255) & '\uff00' | (var22 & 255) * (var76 & 255) >> 8;
               this.method3385(true, var2, var3, var4, var5, var6, var7, var8, var9, var10, var11, var12, Class54.method1306(var33, var25, var26, 1372221625), Class54.method1306(var33, var25, var27, 1372221625), Class54.method1306(var33, var25, var28, 1372221625));
               return;
            }

            this.anInt1734 = var31;
            this.anInt1752 = this.aClass103_Sub2_1743.method15365(var29);
            this.anInt1744 = this.anInt1752 - 1;
            this.aClass529_1746 = this.aClass103_Sub2_1743.method15366(var29);
            this.aBool1741 = this.aClass103_Sub2_1743.method15396(var29);
            this.anInt1747 = this.aClass103_Sub2_1743.method15367(var29) & 255;
         }

         this.anInt1740 = var25;
         float var32;
         if(var4 > var5 || var4 > var6) {
            if(var5 <= var6) {
               var32 = var7;
         ...
         if(var4 < (float)this.anInt1726) {
            ...
            if(var5 < var6) {
               ...
               if((var4 == var5 || var64 >= var44) && (var4 != var5 || var64 <= var54)) {
                  ...
                  for(var4 = (float)this.anIntArray1730[(int)var4]; --var5 >= 0.0F; var4 += (float)this.anInt1737) {
                     this.method3353(var2, var3, this.anIntArray1751, this.anIntArray1725, (int)var4, (int)var7, (int)var9, var10, var12, var13, var15, var16, var18, var19, var21, var26, var28, var32, var34, var35, var37, var38, var40, var41, var43);
                     var7 += var44;
                     var9 += var64;
                     var10 += var45;
                     var12 += var65;
                  ...
                  while(--var6 >= 0.0F) {
                     this.method3353(var2, var3, this.anIntArray1751, this.anIntArray1725, (int)var4, (int)var8, (int)var9, var11, var12, var14, var15, var17, var18, var20, var21, var27, var28, var75, var34, var36, var37, var39, var40, var42, var43);
                     var8 += var54;
                     var9 += var64;
                     var11 += var55;
                     var12 += var65;
                  ...
                  for(var4 = (float)this.anIntArray1730[(int)var4]; --var5 >= 0.0F; var4 += (float)this.anInt1737) {
                     this.method3353(var2, var3, this.anIntArray1751, this.anIntArray1725, (int)var4, (int)var9, (int)var7, var12, var10, var15, var13, var18, var16, var21, var19, var28, var26, var34, var32, var37, var35, var40, var38, var43, var41);
                     var7 += var44;
                     var9 += var64;
                     var10 += var45;
                     var12 += var65;
                  ...
                  while(--var6 >= 0.0F) {
                     this.method3353(var2, var3, this.anIntArray1751, this.anIntArray1725, (int)var4, (int)var9, (int)var8, var12, var11, var15, var14, var18, var17, var21, var20, var28, var27, var34, var75, var37, var36, var40, var39, var43, var42);
                     var8 += var54;
                     var9 += var64;
                     var11 += var55;
                     var12 += var65;
               ...
               if((var4 == var6 || var64 >= var44) && (var4 != var6 || var54 <= var44)) {
                  ...
                  for(var4 = (float)this.anIntArray1730[(int)var4]; --var6 >= 0.0F; var4 += (float)this.anInt1737) {
                     this.method3353(var2, var3, this.anIntArray1751, this.anIntArray1725, (int)var4, (int)var7, (int)var8, var10, var11, var13, var14, var16, var17, var19, var20, var26, var27, var32, var75, var35, var36, var38, var39, var41, var42);
                     var8 += var64;
                     var7 += var44;
                     var11 += var65;
                     var10 += var45;
                  ...
                  for(var4 = (float)this.anIntArray1730[(int)var4]; --var6 >= 0.0F; var4 += (float)this.anInt1737) {
                     this.method3353(var2, var3, this.anIntArray1751, this.anIntArray1725, (int)var4, (int)var8, (int)var7, var11, var10, var14, var13, var17, var16, var20, var19, var27, var26, var75, var32, var36, var35, var39, var38, var42, var41);
                     var7 += var44;
                     var8 += var64;
                     var10 += var45;
                     var11 += var65;
      ...
      if(var7 < var8) {
         ...
         if(this.aBool1756) {
            ...
            if(this.aBool1721) {
               ...
               } else if(!this.aBool1722) {
                  var17 = this.anInt1723;
                  var18 = 256 - this.anInt1723;
                  if(var6 > 0) {
                     do {
                        var5 = -16777216 | (int)var11 & 16711680 | (int)var13 & '\uff00' | (int)var15 & 255;
                        var11 += var12;
                  ...
                  if(this.anInt1723 == 0) {
                     if(var6 > 0) {
                        do {
                           ...
                           var15 += var16;
                           ++var4;
                           if(!var1 || var9 < this.aFloatArray1739[var4]) {
                              var3[var4] = var5;
                              if(var1) {
                                 this.aFloatArray1739[var4] = var9;
                              }
                           }
   ...
   final void method3353(boolean var1, boolean var2, int[] var3, int[] var4, int var5, int var6, int var7, float var8, float var9, float var10, float var11, float var12, float var13, float var14, float var15, float var16, float var17, float var18, float var19, float var20, float var21, float var22, float var23, float var24, float var25) {
      ...
      if(var6 < var7) {
         ...
         for(var5 += var6; var26-- > 0; var24 += var36) {
            ...
            if(!var1 || var37 < this.aFloatArray1739[var5]) {
               int var39 = (int)(var12 * var38 * (float)this.anInt1752);
               if(this.aBool1741) {
                  var39 &= this.anInt1744;
               } else if(var39 < 0) {
                  var39 = 0;
               } else if(var39 > this.anInt1744) {
                  var39 = this.anInt1744;
               }

               int var40 = (int)(var14 * var38 * (float)this.anInt1752);
               if(this.aBool1741) {
                  var40 &= this.anInt1744;
               } else if(var40 < 0) {
                  var40 = 0;
               } else if(var40 > this.anInt1744) {
                  var40 = this.anInt1744;
               }

               int var41 = this.anIntArray1725[var40 * this.anInt1752 + var39];
               boolean var42 = true;
               int var46;
               if(this.aClass529_1746 == Class529.aClass529_6944) {
                  var46 = (int)((float)(var41 >> 24 & 255) * var18 / 255.0F);
               } else if(this.aClass529_1746 == Class529.aClass529_6943) {
                  if((var41 >> 24 & 255) > this.anInt1747) {
                     var46 = 255;
                  } else {
                     var46 = 0;
                  }
               ...
               if(var46 != 0) {
                  ...
                  if(var46 != 255) {
                     ...
                     if(var16 != 0.0F) {
                        ...
                        var45 = ((this.anInt1740 & 16711935) * (int)var16 & -16711936 | (this.anInt1740 & '\uff00') * (int)var16 & 16711680) >>> 8;
                     ...
                     if(var1) {
                        this.aFloatArray1739[var5] = var37;
                     }
                  } else {
                     var43 = -16777216 | (int)(var20 * (float)(var41 >> 16 & 255)) << 8 & 16711680 | (int)(var22 * (float)(var41 >> 8 & 255)) & '\uff00' | (int)(var24 * (float)(var41 & 255)) >> 8;
                     if(var16 != 0.0F) {
   ...
   final void method3355(boolean var1, boolean var2, boolean var3, float var4, float var5, float var6, float var7, float var8, float var9, float var10, float var11, float var12, float var13, float var14, float var15, float var16, float var17, float var18, float var19, float var20, float var21, int var22, int var23, int var24, int var25, float var26, float var27, float var28, int var29, int var30, float var31, int var32, int var33, float var34, int var35, int var36, float var37) {
      if(!var1) {
         ...
         int var96;
         int var97;
         if(var98 != this.anInt1734) {
            this.anIntArray1725 = this.aClass103_Sub2_1743.method15389(var29, var30);
            if(this.anIntArray1725 == null) {
               this.anInt1734 = -1;
               this.anInt1723 = 255 - (var22 >> 24 & 255);
               var96 = Class474.anIntArray6382[Class241_Sub42.method16451(this.aClass103_Sub2_1743.method15368(var29), 1711635828) & '\uffff'];
               var97 = -16777216 | (var22 >> 16 & 255) * (var96 >> 16 & 255) << 8 & 16711680 | (var22 >> 8 & 255) * (var96 >> 8 & 255) & '\uff00' | (var22 & 255) * (var96 & 255) >> 8;
               this.method3385(true, var2, var3, var4, var5, var6, var7, var8, var9, var10, var11, var12, Class54.method1306(var97, var25, var26, 1372221625), Class54.method1306(var97, var25, var27, 1372221625), Class54.method1306(var97, var25, var28, 1372221625));
               return;
            }

            this.anInt1734 = var98;
            this.anInt1752 = this.aClass103_Sub2_1743.method15365(var29);
            this.anInt1744 = this.anInt1752 - 1;
            this.aClass529_1746 = this.aClass103_Sub2_1743.method15366(var29);
         }

         this.aFloat1745 = var31;
         if(var39 != this.anInt1749) {
            this.anIntArray1750 = this.aClass103_Sub2_1743.method15389(var32, var33);
            if(this.anIntArray1750 == null) {
               this.anInt1749 = -1;
               this.anInt1723 = 255 - (var22 >> 24 & 255);
               var96 = Class474.anIntArray6382[Class241_Sub42.method16451(this.aClass103_Sub2_1743.method15368(var32), -594430289) & '\uffff'];
               var97 = -16777216 | (var22 >> 16 & 255) * (var96 >> 16 & 255) << 8 & 16711680 | (var22 >> 8 & 255) * (var96 >> 8 & 255) & '\uff00' | (var22 & 255) * (var96 & 255) >> 8;
               this.method3385(true, var2, var3, var4, var5, var6, var7, var8, var9, var10, var11, var12, Class54.method1306(var97, var25, var26, 1372221625), Class54.method1306(var97, var25, var27, 1372221625), Class54.method1306(var97, var25, var28, 1372221625));
               return;
            }

            this.anInt1749 = var39;
            this.anInt1757 = this.aClass103_Sub2_1743.method15365(var32);
            this.anInt1742 = this.anInt1757 - 1;
         }

         this.aFloat1753 = var34;
         if(var40 != this.anInt1754) {
            this.anIntArray1755 = this.aClass103_Sub2_1743.method15389(var35, var36);
            if(this.anIntArray1755 == null) {
               this.anInt1754 = -1;
               this.anInt1723 = 255 - (var22 >> 24 & 255);
               var96 = Class474.anIntArray6382[Class241_Sub42.method16451(this.aClass103_Sub2_1743.method15368(var35), -395807928) & '\uffff'];
               var97 = -16777216 | (var22 >> 16 & 255) * (var96 >> 16 & 255) << 8 & 16711680 | (var22 >> 8 & 255) * (var96 >> 8 & 255) & '\uff00' | (var22 & 255) * (var96 & 255) >> 8;
               this.method3385(true, var2, var3, (float)((int)var4), (float)((int)var5), (float)((int)var6), (float)((int)var7), (float)((int)var8), (float)((int)var9), (float)((int)var10), (float)((int)var11), (float)((int)var12), Class54.method1306(var97, var25, var26, 1372221625), Class54.method1306(var97, var25, var27, 1372221625), Class54.method1306(var97, var25, var28, 1372221625));
               return;
            }

            this.anInt1754 = var40;
            this.anInt1738 = this.aClass103_Sub2_1743.method15365(var35);
            this.anInt1735 = this.anInt1738 - 1;
         }

         this.aFloat1758 = var37;
         var16 /= var13;
         var17 /= var14;
         var18 /= var15;
         var19 /= var13;
         ...
         if(var4 < (float)this.anInt1726) {
            ...
            if(var5 < var6) {
               ...
               if((var4 == var5 || var83 >= var59) && (var4 != var5 || var83 <= var71)) {
                  ...
                  for(var4 = (float)this.anIntArray1730[(int)var4]; --var5 >= 0.0F; var4 += (float)this.anInt1737) {
                     this.method3343(var2, var3, this.anIntArray1751, (int)var4, (int)var7, (int)var9, var10, var12, var13, var15, var16, var18, var19, var21, var26, var28, var41, var43, var44, var46, var47, var49, var50, var52, var53, var55, var56, var58);
                     var7 += var59;
                     var9 += var83;
                     var10 += var60;
                     var12 += var84;
                  ...
                  while(--var6 >= 0.0F) {
                     this.method3343(var2, var3, this.anIntArray1751, (int)var4, (int)var8, (int)var9, var11, var12, var14, var15, var17, var18, var20, var21, var27, var28, var42, var43, var45, var46, var48, var49, var51, var52, var54, var55, var57, var58);
                     var8 += var71;
                     var9 += var83;
                     var11 += var72;
                     var12 += var84;
                  ...
                  for(var4 = (float)this.anIntArray1730[(int)var4]; --var5 >= 0.0F; var4 += (float)this.anInt1737) {
                     this.method3343(var2, var3, this.anIntArray1751, (int)var4, (int)var9, (int)var7, var12, var10, var15, var13, var18, var16, var21, var19, var28, var26, var43, var41, var46, var44, var49, var47, var52, var50, var55, var53, var58, var56);
                     var7 += var59;
                     var9 += var83;
                     var10 += var60;
                     var12 += var84;
                  ...
                  while(--var6 >= 0.0F) {
                     this.method3343(var2, var3, this.anIntArray1751, (int)var4, (int)var9, (int)var8, var12, var11, var15, var14, var18, var17, var21, var20, var28, var27, var43, var42, var46, var45, var49, var48, var52, var51, var55, var54, var58, var57);
                     var8 += var71;
                     var9 += var83;
                     var11 += var72;
                     var12 += var84;
               ...
               if((var4 == var6 || var83 >= var59) && (var4 != var6 || var71 <= var59)) {
                  ...
                  for(var4 = (float)this.anIntArray1730[(int)var4]; --var6 >= 0.0F; var4 += (float)this.anInt1737) {
                     this.method3343(var2, var3, this.anIntArray1751, (int)var4, (int)var7, (int)var8, var10, var11, var13, var14, var16, var17, var19, var20, var26, var27, var41, var42, var44, var45, var47, var48, var50, var51, var53, var54, var56, var57);
                     var8 += var83;
                     var7 += var59;
                     var11 += var84;
                     var10 += var60;
                  ...
                  for(var4 = (float)this.anIntArray1730[(int)var4]; --var6 >= 0.0F; var4 += (float)this.anInt1737) {
                     this.method3343(var2, var3, this.anIntArray1751, (int)var4, (int)var8, (int)var7, var11, var10, var14, var13, var17, var16, var20, var19, var27, var26, var42, var41, var45, var44, var48, var47, var51, var50, var54, var53, var57, var56);
                     var7 += var59;
                     var8 += var83;
                     var10 += var60;
                     var11 += var84;
   ...
   final void method3361(boolean var1, boolean var2, boolean var3, float var4, float var5, float var6, float var7, float var8, float var9, float var10, float var11, float var12, float var13, float var14, float var15) {
      if(!var1) {
         this.method3377(false, var2, var3, var4, var5, var6, var7, var8, var9, var10, var11, var12, 0);
      } else if(this.aBool1724) {
         this.aClass103_Sub2_1743.method2517((int)var7, (int)var4, (int)var8, (int)var5, Class474.anIntArray6382[(int)var13 & '\uffff'], 223909001);
         this.aClass103_Sub2_1743.method2517((int)var8, (int)var5, (int)var9, (int)var6, Class474.anIntArray6382[(int)var13 & '\uffff'], 223909001);
         this.aClass103_Sub2_1743.method2517((int)var9, (int)var6, (int)var7, (int)var4, Class474.anIntArray6382[(int)var13 & '\uffff'], 223909001);
      } else {
            ...
            if(var4 <= var5 && var4 <= var6) {
               if(var4 < (float)this.anInt1726) {
                  ...
                  if(var5 < var6) {
                     ...
                     if((var4 == var5 || var26 >= var25) && (var4 != var5 || var26 <= var24)) {
                        ...
                        for(var4 = (float)this.anIntArray1730[(int)var4]; --var5 >= 0.0F; var4 += (float)this.anInt1737) {
                           this.method3347(var2, var3, this.anIntArray1751, (int)var4, 0, 0, (int)var7, (int)var9, var13, var28, var10, var30);
                           var9 += var26;
                           var7 += var25;
                           var13 += var29;
                           var10 += var31;
                        ...
                        while(--var6 >= 0.0F) {
                           this.method3347(var2, var3, this.anIntArray1751, (int)var4, 0, 0, (int)var8, (int)var9, var13, var28, var10, var30);
                           var9 += var26;
                           var8 += var24;
                           var13 += var29;
                           var10 += var31;
                        ...
                        for(var4 = (float)this.anIntArray1730[(int)var4]; --var5 >= 0.0F; var4 += (float)this.anInt1737) {
                           this.method3347(var2, var3, this.anIntArray1751, (int)var4, 0, 0, (int)var9, (int)var7, var13, var28, var10, var30);
                           var9 += var26;
                           var7 += var25;
                           var13 += var29;
                           var10 += var31;
                        ...
                        while(--var6 >= 0.0F) {
                           this.method3347(var2, var3, this.anIntArray1751, (int)var4, 0, 0, (int)var9, (int)var8, var13, var28, var10, var30);
                           var9 += var26;
                           var8 += var24;
                           var13 += var29;
                           var10 += var31;
                     ...
                     if((var4 == var6 || var26 >= var25) && (var4 != var6 || var24 <= var25)) {
                        ...
                        for(var4 = (float)this.anIntArray1730[(int)var4]; --var6 >= 0.0F; var4 += (float)this.anInt1737) {
                           this.method3347(var2, var3, this.anIntArray1751, (int)var4, 0, 0, (int)var7, (int)var8, var13, var28, var10, var30);
                           var8 += var26;
                           var7 += var25;
                           var13 += var29;
                           var10 += var31;
                        ...
                        for(var4 = (float)this.anIntArray1730[(int)var4]; --var6 >= 0.0F; var4 += (float)this.anInt1737) {
                           this.method3347(var2, var3, this.anIntArray1751, (int)var4, 0, 0, (int)var8, (int)var7, var13, var28, var10, var30);
                           var8 += var26;
                           var7 += var25;
                           var13 += var29;
                           var10 += var31;
               ...
               if(var5 < (float)this.anInt1726) {
                  ...
                  if(var6 < var4) {
                     ...
                     if((var5 == var6 || var25 >= var24) && (var5 != var6 || var25 <= var26)) {
                        ...
                        for(var5 = (float)this.anIntArray1730[(int)var5]; --var6 >= 0.0F; var5 += (float)this.anInt1737) {
                           this.method3347(var2, var3, this.anIntArray1751, (int)var5, 0, 0, (int)var8, (int)var7, var14, var28, var11, var30);
                           var7 += var25;
                           var8 += var24;
                           var14 += var29;
                           var11 += var31;
                        ...
                        while(--var4 >= 0.0F) {
                           this.method3347(var2, var3, this.anIntArray1751, (int)var5, 0, 0, (int)var9, (int)var7, var14, var28, var11, var30);
                           var7 += var25;
                           var9 += var26;
                           var14 += var29;
                           var11 += var31;
                        ...
                        for(var5 = (float)this.anIntArray1730[(int)var5]; --var6 >= 0.0F; var5 += (float)this.anInt1737) {
                           this.method3347(var2, var3, this.anIntArray1751, (int)var5, 0, 0, (int)var7, (int)var8, var14, var28, var11, var30);
                           var7 += var25;
                           var8 += var24;
                           var14 += var29;
                           var11 += var31;
                        ...
                        while(--var4 >= 0.0F) {
                           this.method3347(var2, var3, this.anIntArray1751, (int)var5, 0, 0, (int)var7, (int)var9, var14, var28, var11, var30);
                           var7 += var25;
                           var9 += var26;
                           var14 += var29;
                           var11 += var31;
                     ...
                     if(var25 < var24) {
                        ...
                        for(var5 = (float)this.anIntArray1730[(int)var5]; --var4 >= 0.0F; var5 += (float)this.anInt1737) {
                           this.method3347(var2, var3, this.anIntArray1751, (int)var5, 0, 0, (int)var9, (int)var8, var14, var28, var11, var30);
                           var9 += var25;
                           var8 += var24;
                           var14 += var29;
                           var11 += var31;
                        ...
                        for(var5 = (float)this.anIntArray1730[(int)var5]; --var4 >= 0.0F; var5 += (float)this.anInt1737) {
                           this.method3347(var2, var3, this.anIntArray1751, (int)var5, 0, 0, (int)var8, (int)var9, var14, var28, var11, var30);
                           var9 += var25;
                           var8 += var24;
                           var14 += var29;
                           var11 += var31;
               ...
               if(var4 < var5) {
                  ...
                  if(var24 < var26) {
                     ...
                     for(var6 = (float)this.anIntArray1730[(int)var6]; --var4 >= 0.0F; var6 += (float)this.anInt1737) {
                        this.method3347(var2, var3, this.anIntArray1751, (int)var6, 0, 0, (int)var8, (int)var9, var15, var28, var12, var30);
                        var8 += var24;
                        var9 += var26;
                        var15 += var29;
                        var12 += var31;
                     ...
                     while(--var5 >= 0.0F) {
                        this.method3347(var2, var3, this.anIntArray1751, (int)var6, 0, 0, (int)var8, (int)var7, var15, var28, var12, var30);
                        var8 += var24;
                        var7 += var25;
                        var15 += var29;
                        var12 += var31;
                     ...
                     for(var6 = (float)this.anIntArray1730[(int)var6]; --var4 >= 0.0F; var6 += (float)this.anInt1737) {
                        this.method3347(var2, var3, this.anIntArray1751, (int)var6, 0, 0, (int)var9, (int)var8, var15, var28, var12, var30);
                        var8 += var24;
                        var9 += var26;
                        var15 += var29;
                        var12 += var31;
                     ...
                     while(--var5 >= 0.0F) {
                        this.method3347(var2, var3, this.anIntArray1751, (int)var6, 0, 0, (int)var7, (int)var8, var15, var28, var12, var30);
                        var8 += var24;
                        var7 += var25;
                        var15 += var29;
                        var12 += var31;
                  ...
                  if(var24 < var26) {
                     ...
                     for(var6 = (float)this.anIntArray1730[(int)var6]; --var5 >= 0.0F; var6 += (float)this.anInt1737) {
                        this.method3347(var2, var3, this.anIntArray1751, (int)var6, 0, 0, (int)var7, (int)var9, var15, var28, var12, var30);
                        var7 += var24;
                        var9 += var26;
                        var15 += var29;
                        var12 += var31;
                     ...
                     for(var6 = (float)this.anIntArray1730[(int)var6]; --var5 >= 0.0F; var6 += (float)this.anInt1737) {
                        this.method3347(var2, var3, this.anIntArray1751, (int)var6, 0, 0, (int)var9, (int)var7, var15, var28, var12, var30);
                        var7 += var24;
                        var9 += var26;
                        var15 += var29;
                        var12 += var31;
   ...
   final void method3366(boolean var1, boolean var2, boolean var3, float var4, float var5, float var6, float var7, float var8, float var9, float var10, float var11, float var12, int var13, int var14, int var15) {
      if(!var1) {
         ...
         this.aClass103_Sub2_1743.method2517((int)var7, (int)var4, (int)var8, (int)var5, -16777216 | var13, 223909001);
         this.aClass103_Sub2_1743.method2517((int)var8, (int)var5, (int)var9, (int)var6, -16777216 | var13, 223909001);
         this.aClass103_Sub2_1743.method2517((int)var9, (int)var6, (int)var7, (int)var4, -16777216 | var13, 223909001);
      } else {
         float var16 = var8 - var7;
         float var17 = var5 - var4;
         float var18 = var9 - var7;
            ...
            if(var4 <= var5 && var4 <= var6) {
               if(var4 < (float)this.anInt1726) {
                  ...
                  if(var5 < var6) {
                     ...
                     if((var4 == var5 || var30 >= var29) && (var4 != var5 || var30 <= var28)) {
                        ...
                        for(var4 = (float)this.anIntArray1730[(int)var4]; --var5 >= 0.0F; var4 += (float)this.anInt1737) {
                           this.method3349(var2, var3, this.anIntArray1751, (int)var4, 0, 0, (int)var7, (int)var9, var10, var32, var40, var34, var41, var36, var42, var38);
                           var9 += var30;
                           var7 += var29;
                           var10 += var33;
                           var40 += var35;
                        ...
                        while(--var6 >= 0.0F) {
                           this.method3349(var2, var3, this.anIntArray1751, (int)var4, 0, 0, (int)var8, (int)var9, var10, var32, var40, var34, var41, var36, var42, var38);
                           var9 += var30;
                           var8 += var28;
                           var10 += var33;
                           var40 += var35;
                        ...
                        for(var4 = (float)this.anIntArray1730[(int)var4]; --var5 >= 0.0F; var4 += (float)this.anInt1737) {
                           this.method3349(var2, var3, this.anIntArray1751, (int)var4, 0, 0, (int)var9, (int)var7, var10, var32, var40, var34, var41, var36, var42, var38);
                           var9 += var30;
                           var7 += var29;
                           var10 += var33;
                           var40 += var35;
                        ...
                        while(--var6 >= 0.0F) {
                           this.method3349(var2, var3, this.anIntArray1751, (int)var4, 0, 0, (int)var9, (int)var8, var10, var32, var40, var34, var41, var36, var42, var38);
                           var9 += var30;
                           var8 += var28;
                           var10 += var33;
                           var40 += var35;
                     ...
                     if((var4 == var6 || var30 >= var29) && (var4 != var6 || var28 <= var29)) {
                        ...
                        for(var4 = (float)this.anIntArray1730[(int)var4]; --var6 >= 0.0F; var4 += (float)this.anInt1737) {
                           this.method3349(var2, var3, this.anIntArray1751, (int)var4, 0, 0, (int)var7, (int)var8, var10, var32, var40, var34, var41, var36, var42, var38);
                           var8 += var30;
                           var7 += var29;
                           var10 += var33;
                           var40 += var35;
                        ...
                        for(var4 = (float)this.anIntArray1730[(int)var4]; --var6 >= 0.0F; var4 += (float)this.anInt1737) {
                           this.method3349(var2, var3, this.anIntArray1751, (int)var4, 0, 0, (int)var8, (int)var7, var10, var32, var40, var34, var41, var36, var42, var38);
                           var8 += var30;
                           var7 += var29;
                           var10 += var33;
                           var40 += var35;
               ...
               if(var5 < (float)this.anInt1726) {
                  ...
                  if(var6 < var4) {
                     ...
                     if((var5 == var6 || var29 >= var28) && (var5 != var6 || var29 <= var30)) {
                        ...
                        for(var5 = (float)this.anIntArray1730[(int)var5]; --var6 >= 0.0F; var5 += (float)this.anInt1737) {
                           this.method3349(var2, var3, this.anIntArray1751, (int)var5, 0, 0, (int)var8, (int)var7, var11, var32, var40, var34, var41, var36, var42, var38);
                           var7 += var29;
                           var8 += var28;
                           var11 += var33;
                           var40 += var35;
                        ...
                        while(--var4 >= 0.0F) {
                           this.method3349(var2, var3, this.anIntArray1751, (int)var5, 0, 0, (int)var9, (int)var7, var11, var32, var40, var34, var41, var36, var42, var38);
                           var7 += var29;
                           var9 += var30;
                           var11 += var33;
                           var40 += var35;
                        ...
                        for(var5 = (float)this.anIntArray1730[(int)var5]; --var6 >= 0.0F; var5 += (float)this.anInt1737) {
                           this.method3349(var2, var3, this.anIntArray1751, (int)var5, 0, 0, (int)var7, (int)var8, var11, var32, var40, var34, var41, var36, var42, var38);
                           var7 += var29;
                           var8 += var28;
                           var11 += var33;
                           var40 += var35;
                        ...
                        while(--var4 >= 0.0F) {
                           this.method3349(var2, var3, this.anIntArray1751, (int)var5, 0, 0, (int)var7, (int)var9, var11, var32, var40, var34, var41, var36, var42, var38);
                           var7 += var29;
                           var9 += var30;
                           var11 += var33;
                           var40 += var35;
                     ...
                     if(var29 < var28) {
                        ...
                        for(var5 = (float)this.anIntArray1730[(int)var5]; --var4 >= 0.0F; var5 += (float)this.anInt1737) {
                           this.method3349(var2, var3, this.anIntArray1751, (int)var5, 0, 0, (int)var9, (int)var8, var11, var32, var40, var34, var41, var36, var42, var38);
                           var9 += var29;
                           var8 += var28;
                           var11 += var33;
                           var40 += var35;
                        ...
                        for(var5 = (float)this.anIntArray1730[(int)var5]; --var4 >= 0.0F; var5 += (float)this.anInt1737) {
                           this.method3349(var2, var3, this.anIntArray1751, (int)var5, 0, 0, (int)var8, (int)var9, var11, var32, var40, var34, var41, var36, var42, var38);
                           var9 += var29;
                           var8 += var28;
                           var11 += var33;
                           var40 += var35;
               ...
               if(var4 < var5) {
                  ...
                  if(var28 < var30) {
                     ...
                     for(var6 = (float)this.anIntArray1730[(int)var6]; --var4 >= 0.0F; var6 += (float)this.anInt1737) {
                        this.method3349(var2, var3, this.anIntArray1751, (int)var6, 0, 0, (int)var8, (int)var9, var12, var32, var40, var34, var41, var36, var42, var38);
                        var8 += var28;
                        var9 += var30;
                        var12 += var33;
                        var40 += var35;
                     ...
                     while(--var5 >= 0.0F) {
                        this.method3349(var2, var3, this.anIntArray1751, (int)var6, 0, 0, (int)var8, (int)var7, var12, var32, var40, var34, var41, var36, var42, var38);
                        var8 += var28;
                        var7 += var29;
                        var12 += var33;
                        var40 += var35;
                     ...
                     for(var6 = (float)this.anIntArray1730[(int)var6]; --var4 >= 0.0F; var6 += (float)this.anInt1737) {
                        this.method3349(var2, var3, this.anIntArray1751, (int)var6, 0, 0, (int)var9, (int)var8, var12, var32, var40, var34, var41, var36, var42, var38);
                        var8 += var28;
                        var9 += var30;
                        var12 += var33;
                        var40 += var35;
                     ...
                     while(--var5 >= 0.0F) {
                        this.method3349(var2, var3, this.anIntArray1751, (int)var6, 0, 0, (int)var7, (int)var8, var12, var32, var40, var34, var41, var36, var42, var38);
                        var8 += var28;
                        var7 += var29;
                        var12 += var33;
                        var40 += var35;
                  ...
                  if(var28 < var30) {
                     ...
                     for(var6 = (float)this.anIntArray1730[(int)var6]; --var5 >= 0.0F; var6 += (float)this.anInt1737) {
                        this.method3349(var2, var3, this.anIntArray1751, (int)var6, 0, 0, (int)var7, (int)var9, var12, var32, var40, var34, var41, var36, var42, var38);
                        var7 += var28;
                        var9 += var30;
                        var12 += var33;
                        var40 += var35;
                     ...
                     for(var6 = (float)this.anIntArray1730[(int)var6]; --var5 >= 0.0F; var6 += (float)this.anInt1737) {
                        this.method3349(var2, var3, this.anIntArray1751, (int)var6, 0, 0, (int)var9, (int)var7, var12, var32, var40, var34, var41, var36, var42, var38);
                        var7 += var28;
                        var9 += var30;
                        var12 += var33;
                        var40 += var35;
      ...
      if(!var1) {
         ...
         if(var98 != this.anInt1734) {
            ...
            if(this.anIntArray1725 == null) {
               this.anInt1734 = -1;
               this.anInt1723 = 255 - (var22 >> 24 & 255);
               var96 = Class474.anIntArray6382[Class241_Sub42.method16451(this.aClass103_Sub2_1743.method15368(var29), 641433841) & '\uffff'];
               var97 = -16777216 | (var22 >> 16 & 255) * (var96 >> 16 & 255) << 8 & 16711680 | (var22 >> 8 & 255) * (var96 >> 8 & 255) & '\uff00' | (var22 & 255) * (var96 & 255) >> 8;
               this.method3385(true, var2, var3, var4, var5, var6, var7, var8, var9, var10, var11, var12, Class54.method1306(var97, var25, var26, 1372221625), Class54.method1306(var97, var25, var27, 1372221625), Class54.method1306(var97, var25, var28, 1372221625));
               return;
            }
         ...
         if(var39 != this.anInt1749) {
            ...
            if(this.anIntArray1750 == null) {
               this.anInt1749 = -1;
               this.anInt1723 = 255 - (var22 >> 24 & 255);
               var96 = Class474.anIntArray6382[Class241_Sub42.method16451(this.aClass103_Sub2_1743.method15368(var32), 1093846664) & '\uffff'];
               var97 = -16777216 | (var22 >> 16 & 255) * (var96 >> 16 & 255) << 8 & 16711680 | (var22 >> 8 & 255) * (var96 >> 8 & 255) & '\uff00' | (var22 & 255) * (var96 & 255) >> 8;
               this.method3385(true, var2, var3, var4, var5, var6, var7, var8, var9, var10, var11, var12, Class54.method1306(var97, var25, var26, 1372221625), Class54.method1306(var97, var25, var27, 1372221625), Class54.method1306(var97, var25, var28, 1372221625));
               return;
            }
         ...
         if(var40 != this.anInt1754) {
            ...
            if(this.anIntArray1755 == null) {
               this.anInt1754 = -1;
               this.anInt1723 = 255 - (var22 >> 24 & 255);
               var96 = Class474.anIntArray6382[Class241_Sub42.method16451(this.aClass103_Sub2_1743.method15368(var35), 1112858046) & '\uffff'];
               var97 = -16777216 | (var22 >> 16 & 255) * (var96 >> 16 & 255) << 8 & 16711680 | (var22 >> 8 & 255) * (var96 >> 8 & 255) & '\uff00' | (var22 & 255) * (var96 & 255) >> 8;
               this.method3385(true, var2, var3, (float)((int)var4), (float)((int)var5), (float)((int)var6), (float)((int)var7), (float)((int)var8), (float)((int)var9), (float)((int)var10), (float)((int)var11), (float)((int)var12), Class54.method1306(var97, var25, var26, 1372221625), Class54.method1306(var97, var25, var27, 1372221625), Class54.method1306(var97, var25, var28, 1372221625));
               return;
            }
   ...
   final void method3372(boolean var1, boolean var2, boolean var3, int[] var4, int var5, int var6, int var7, int var8, int var9, float var10, float var11) {
      ...
      if(var8 < var9) {
         ...
         if(this.aClass189_1736.aBool2220) {
            if(this.anInt1723 == 0) {
               while(true) {
                  ...
                  if(var7 < 0) {
                     ...
                     while(true) {
                        ...
                        ++var5;
                        if(!var2 || var10 < this.aFloatArray1739[var5]) {
                           if(var1) {
                              var4[var5] = var6;
                           }

                           if(var2) {
                              this.aFloatArray1739[var5] = var10;
                           }
                        }
            ...
            } else if(this.anInt1723 == 254) {
               if(var8 != 0 && var9 <= this.anInt1733 - 1) {
                  while(true) {
                     --var7;
                     if(var7 < 0) {
                        var7 = var9 - var8 & 3;
                        ...
                        while(true) {
                           ...
                           ++var5;
                           if((!var2 || var10 < this.aFloatArray1739[var5]) && var1) {
               ...
               var12 = this.anInt1723;
               var13 = 256 - this.anInt1723;
      ...
      if(!var1) {
         ...
         if(var98 != this.anInt1734) {
            ...
            if(this.anIntArray1725 == null) {
               this.anInt1734 = -1;
               this.anInt1723 = 255 - (var22 >> 24 & 255);
               var96 = Class474.anIntArray6382[Class241_Sub42.method16451(this.aClass103_Sub2_1743.method15368(var29), 2014625391) & '\uffff'];
               var97 = -16777216 | (var22 >> 16 & 255) * (var96 >> 16 & 255) << 8 & 16711680 | (var22 >> 8 & 255) * (var96 >> 8 & 255) & '\uff00' | (var22 & 255) * (var96 & 255) >> 8;
               this.method3385(true, var2, var3, var4, var5, var6, var7, var8, var9, var10, var11, var12, Class54.method1306(var97, var25, var26, 1372221625), Class54.method1306(var97, var25, var27, 1372221625), Class54.method1306(var97, var25, var28, 1372221625));
               return;
            }
         ...
         if(var39 != this.anInt1749) {
            ...
            if(this.anIntArray1750 == null) {
               this.anInt1749 = -1;
               this.anInt1723 = 255 - (var22 >> 24 & 255);
               var96 = Class474.anIntArray6382[Class241_Sub42.method16451(this.aClass103_Sub2_1743.method15368(var32), -547701251) & '\uffff'];
               var97 = -16777216 | (var22 >> 16 & 255) * (var96 >> 16 & 255) << 8 & 16711680 | (var22 >> 8 & 255) * (var96 >> 8 & 255) & '\uff00' | (var22 & 255) * (var96 & 255) >> 8;
               this.method3385(true, var2, var3, var4, var5, var6, var7, var8, var9, var10, var11, var12, Class54.method1306(var97, var25, var26, 1372221625), Class54.method1306(var97, var25, var27, 1372221625), Class54.method1306(var97, var25, var28, 1372221625));
               return;
            }
         ...
         if(var40 != this.anInt1754) {
            ...
            if(this.anIntArray1755 == null) {
               this.anInt1754 = -1;
               this.anInt1723 = 255 - (var22 >> 24 & 255);
               var96 = Class474.anIntArray6382[Class241_Sub42.method16451(this.aClass103_Sub2_1743.method15368(var35), 2309733) & '\uffff'];
               var97 = -16777216 | (var22 >> 16 & 255) * (var96 >> 16 & 255) << 8 & 16711680 | (var22 >> 8 & 255) * (var96 >> 8 & 255) & '\uff00' | (var22 & 255) * (var96 & 255) >> 8;
               this.method3385(true, var2, var3, (float)((int)var4), (float)((int)var5), (float)((int)var6), (float)((int)var7), (float)((int)var8), (float)((int)var9), (float)((int)var10), (float)((int)var11), (float)((int)var12), Class54.method1306(var97, var25, var26, 1372221625), Class54.method1306(var97, var25, var27, 1372221625), Class54.method1306(var97, var25, var28, 1372221625));
               return;
            }
      ...
      if(!var1) {
         ...
         if(var98 != this.anInt1734) {
            ...
            if(this.anIntArray1725 == null) {
               this.anInt1734 = -1;
               this.anInt1723 = 255 - (var22 >> 24 & 255);
               var96 = Class474.anIntArray6382[Class241_Sub42.method16451(this.aClass103_Sub2_1743.method15368(var29), 155145138) & '\uffff'];
               var97 = -16777216 | (var22 >> 16 & 255) * (var96 >> 16 & 255) << 8 & 16711680 | (var22 >> 8 & 255) * (var96 >> 8 & 255) & '\uff00' | (var22 & 255) * (var96 & 255) >> 8;
               this.method3385(true, var2, var3, var4, var5, var6, var7, var8, var9, var10, var11, var12, Class54.method1306(var97, var25, var26, 1372221625), Class54.method1306(var97, var25, var27, 1372221625), Class54.method1306(var97, var25, var28, 1372221625));
               return;
            }
         ...
         if(var39 != this.anInt1749) {
            ...
            if(this.anIntArray1750 == null) {
               this.anInt1749 = -1;
               this.anInt1723 = 255 - (var22 >> 24 & 255);
               var96 = Class474.anIntArray6382[Class241_Sub42.method16451(this.aClass103_Sub2_1743.method15368(var32), 320825277) & '\uffff'];
               var97 = -16777216 | (var22 >> 16 & 255) * (var96 >> 16 & 255) << 8 & 16711680 | (var22 >> 8 & 255) * (var96 >> 8 & 255) & '\uff00' | (var22 & 255) * (var96 & 255) >> 8;
               this.method3385(true, var2, var3, var4, var5, var6, var7, var8, var9, var10, var11, var12, Class54.method1306(var97, var25, var26, 1372221625), Class54.method1306(var97, var25, var27, 1372221625), Class54.method1306(var97, var25, var28, 1372221625));
               return;
            }
         ...
         if(var40 != this.anInt1754) {
            ...
            if(this.anIntArray1755 == null) {
               this.anInt1754 = -1;
               this.anInt1723 = 255 - (var22 >> 24 & 255);
               var96 = Class474.anIntArray6382[Class241_Sub42.method16451(this.aClass103_Sub2_1743.method15368(var35), -886695244) & '\uffff'];
               var97 = -16777216 | (var22 >> 16 & 255) * (var96 >> 16 & 255) << 8 & 16711680 | (var22 >> 8 & 255) * (var96 >> 8 & 255) & '\uff00' | (var22 & 255) * (var96 & 255) >> 8;
               this.method3385(true, var2, var3, (float)((int)var4), (float)((int)var5), (float)((int)var6), (float)((int)var7), (float)((int)var8), (float)((int)var9), (float)((int)var10), (float)((int)var11), (float)((int)var12), Class54.method1306(var97, var25, var26, 1372221625), Class54.method1306(var97, var25, var27, 1372221625), Class54.method1306(var97, var25, var28, 1372221625));
               return;
            }
      ...
      if(!var1) {
         ...
         if(var98 != this.anInt1734) {
            ...
            if(this.anIntArray1725 == null) {
               this.anInt1734 = -1;
               this.anInt1723 = 255 - (var22 >> 24 & 255);
               var96 = Class474.anIntArray6382[Class241_Sub42.method16451(this.aClass103_Sub2_1743.method15368(var29), 580628505) & '\uffff'];
               var97 = -16777216 | (var22 >> 16 & 255) * (var96 >> 16 & 255) << 8 & 16711680 | (var22 >> 8 & 255) * (var96 >> 8 & 255) & '\uff00' | (var22 & 255) * (var96 & 255) >> 8;
               this.method3385(true, var2, var3, var4, var5, var6, var7, var8, var9, var10, var11, var12, Class54.method1306(var97, var25, var26, 1372221625), Class54.method1306(var97, var25, var27, 1372221625), Class54.method1306(var97, var25, var28, 1372221625));
               return;
            }
         ...
         if(var39 != this.anInt1749) {
            ...
            if(this.anIntArray1750 == null) {
               this.anInt1749 = -1;
               this.anInt1723 = 255 - (var22 >> 24 & 255);
               var96 = Class474.anIntArray6382[Class241_Sub42.method16451(this.aClass103_Sub2_1743.method15368(var32), -76046514) & '\uffff'];
               var97 = -16777216 | (var22 >> 16 & 255) * (var96 >> 16 & 255) << 8 & 16711680 | (var22 >> 8 & 255) * (var96 >> 8 & 255) & '\uff00' | (var22 & 255) * (var96 & 255) >> 8;
               this.method3385(true, var2, var3, var4, var5, var6, var7, var8, var9, var10, var11, var12, Class54.method1306(var97, var25, var26, 1372221625), Class54.method1306(var97, var25, var27, 1372221625), Class54.method1306(var97, var25, var28, 1372221625));
               return;
            }
         ...
         if(var40 != this.anInt1754) {
            ...
            if(this.anIntArray1755 == null) {
               this.anInt1754 = -1;
               this.anInt1723 = 255 - (var22 >> 24 & 255);
               var96 = Class474.anIntArray6382[Class241_Sub42.method16451(this.aClass103_Sub2_1743.method15368(var35), -1226669089) & '\uffff'];
               var97 = -16777216 | (var22 >> 16 & 255) * (var96 >> 16 & 255) << 8 & 16711680 | (var22 >> 8 & 255) * (var96 >> 8 & 255) & '\uff00' | (var22 & 255) * (var96 & 255) >> 8;
               this.method3385(true, var2, var3, (float)((int)var4), (float)((int)var5), (float)((int)var6), (float)((int)var7), (float)((int)var8), (float)((int)var9), (float)((int)var10), (float)((int)var11), (float)((int)var12), Class54.method1306(var97, var25, var26, 1372221625), Class54.method1306(var97, var25, var27, 1372221625), Class54.method1306(var97, var25, var28, 1372221625));
               return;
            }
      ...
      if(!var1) {
         ...
         if(var31 != this.anInt1734) {
            ...
            if(this.anIntArray1725 == null) {
               ...
               this.anInt1723 = 255 - (var22 >> 24 & 255);
               this.anInt1747 = 0;
               int var76 = Class474.anIntArray6382[Class241_Sub42.method16451(this.aClass103_Sub2_1743.method15368(var29), -291572925) & '\uffff'];
               var33 = -16777216 | (var22 >> 16 & 255) * (var76 >> 16 & 255) << 8 & 16711680 | (var22 >> 8 & 255) * (var76 >> 8 & 255) & '\uff00' | (var22 & 255) * (var76 & 255) >> 8;
               this.method3385(true, var2, var3, var4, var5, var6, var7, var8, var9, var10, var11, var12, Class54.method1306(var33, var25, var26, 1372221625), Class54.method1306(var33, var25, var27, 1372221625), Class54.method1306(var33, var25, var28, 1372221625));
               return;
            }
