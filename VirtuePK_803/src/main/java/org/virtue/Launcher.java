...
import org.virtue.utility.log.Logger;
...
public class Launcher {
	...
	public static void main(String[] args) {
		try {
			...
			logger.info("Welcome to " + Constants.SERVER_NAME + ".");
			loadEngine();
			loadCache();
			...
			logger.info(Constants.SERVER_NAME + " took " + (TimeUtil.currentTimeMillis() - currentTime) + " milli seconds to launch.");
		} catch (Exception e) {
			logger.error("An exception occurred while executing the server", e);
